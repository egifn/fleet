    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv_ng_1' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_NG_1', 'localhost'),
            'port' => env('DB_PORT_NG_1', '1433'),
            'database' => env('DB_DATABASE_NG_1', 'forge'),
            'username' => env('DB_USERNAME_NG_1', 'forge'),
            'password' => env('DB_PASSWORD_NG_1', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
        ...
        'sqlsrv_ng_2' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_NG_2', 'localhost'),
            'port' => env('DB_PORT_NG_2', '1433'),
            'database' => env('DB_DATABASE_NG_2', 'forge'),
            'username' => env('DB_USERNAME_NG_2', 'forge'),
            'password' => env('DB_PASSWORD_NG_2', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
