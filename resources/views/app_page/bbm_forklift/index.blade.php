...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.bbm_forklift.view_excel') }}" target="_blank" method="get" enctype="multipart/form-data">
        @elseif (Auth::user()->roles == 'Admin')
        <form action="{{ route('user.bbm_forklift.view_excel') }}" target="_blank" method="get" enctype="multipart/form-data">
        @elseif (Auth::user()->roles == 'Akunting')
        <form action="{{ route('akunting.bbm_forklift.view_excel') }}" target="_blank" method="get" enctype="multipart/form-data">
        @endif
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Biaya BBM Forklift</h4>
                        <div class="page-title-right">
                            <button class="btn btn-success btn-sm" type="submit">E x c e l </button>
                            @if (Auth::user()->roles == 'Superadmin')
                            <a href="{{ route('admin.bbm_forklift.create') }}" class="btn btn-primary btn-sm">Tambah Biaya BBM <i class="mdi mdi-arrow-right ms-1"></i></a>
                            @elseif (Auth::user()->roles == 'Admin')
                            <a href="{{ route('user.bbm_forklift.create') }}" class="btn btn-primary btn-sm">Tambah Biaya BBM <i class="mdi mdi-arrow-right ms-1"></i></a>
                            @elseif (Auth::user()->roles == 'Akunting')
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive tabel-sm nowrap w-100 tabel-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 7px 5px;">{{ $item_bbm->no_forklift }}</td>
                                        ...
                                        <td style="padding: 7px 5px;">{{ $item_bbm->hour }}</td>
