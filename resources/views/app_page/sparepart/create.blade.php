        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">INPUT BIAYA SPAREPART</h4>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.sparepart.insert') }}" method="post">
                        @elseif (Auth::user()->roles == 'Admin')
                        <form action="{{ route('user.sparepart.insert') }}" method="post">
                        @endif
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="jenis" id="jenis" value="" placeholder="" required readonly>
                                </div>
                            </div>
                            <div class="row mb-1">
                            ...
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Kilometer<span class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="kilometer" id="kilometer" value="" placeholder="" required>
                                </div>
                            </div>
                            {{-- <div class="row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="ratio_aktual" id="ratio_aktual" value="" placeholder="" readonly>
                                </div>
                            </div>
                            <div class="row mb-1">
                            ...
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Biaya Sparepart<span class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="biaya_sparepart" id="biaya_sparepart" value="" placeholder="" required>
                                </div>
                            </div>
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="keterangan_sparepart" id="keterangan_sparepart" value="" placeholder="" required>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">No LKM<span class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="no_lkm" id="no_lkm" value="" placeholder="" required>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">No PMB<span class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="no_pmb" id="no_pmb" value="" placeholder="" required>
                                </div>
                            </div>
                            <div class="row mb-1">
