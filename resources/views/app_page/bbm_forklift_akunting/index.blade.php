                            ...
                            <table class="table table-bordered dt-responsive tabel-sm nowrap w-100 tabel-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 7px 5px;" hidden>{{ $item_bbm->week }}</td>
                                        ...
                                        <td style="padding: 7px 5px;" hidden>{{ $item_bbm->hour }}</td>
...
<script>
    $('#cari').on('click', function() {
        ...
        if (queryString) {
            window.location.href = "{{ route('akunting.bbm_forklift_akunting.view') }}?" + queryString;
        } else {
            window.location.href = "{{ route('akunting.bbm_forklift_akunting.view') }}";
        }
    });
</script>
@endpush