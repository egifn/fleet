@php
    ...
    header("Content-Disposition: attachment; filename=Rekap Pengisian BBM (Kadaluarsa).xls");
@endphp
...
<div class="col-lg-12" style="text-align: center;">
    <b>Rekap Pengisian BBM (Kadaluarsa)</b>
</div>
...
<div>
    ...
    <table>
        ...
        <tbody>
            <?php $no = 1; ?>
            @forelse($dt_bbm_excel_kadaluarsa as $item_bbm)
            <tr>
