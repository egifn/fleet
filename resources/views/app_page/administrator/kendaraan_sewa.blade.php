        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">DATA KENDARAAN SEWA</h4>
                    <form action="{{ route('admin.kendaraan_sewa.kendaraan_sewa_excel') }}" target="_blank" method="get" enctype="multipart/form-data">
                    ...
                    <div class="modal fade modal-form" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form action="{{ route('admin.kendaraan_sewa.insert') }}" method="post">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="modal-body">
                                        <div class="row mb-1">
                                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label">Nomor Polisi </label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-1">
                                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label">Tipe </label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control form-control-sm" name="type" value="" placeholder="" >
                                            </div>
                                        </div>

                                        <div class="row mb-1">
                                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label">kategori </label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control form-control-sm" name="kategori" value="" placeholder="">
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                        ...
                                        <div class="row mb-1">
                                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label">Status Kendaraan</label>
                                            <div class="col-sm-10">
                                                <select class="form-control form-control-sm" name="status_kendaraan" id="status_kendaraan" data-id="0">
                                                    <option value="">Pilih</option>
                                        ...
                                        <div class="row mb-1">
                                            <label for="horizontal-firstname-input" class="col-sm-2 col-form-label">Nama Vendor </label>
                                            <div class="col-sm-10">     
                    ...
                    <div class="card-body">
                       <table id="datatable" class="table table-bordered dt-responsive tabel-sm nowrap w-100 tabel-sm">
                            ...
                            <tbody>
                                ...
                                $no=1;
                                @endphp
                                @foreach ($dt_kendaraan_sewa as $item_kendaraan)
                                <tr>
                                    ...
                                    <td style="padding: 7px 5px;">{{ $item_kendaraan->nama_vendor }}</td>
