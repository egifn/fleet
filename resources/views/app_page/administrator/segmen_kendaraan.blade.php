        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">SEGMEN KENDARAAN</h4>
                    ...
                    <div class="modal fade modal-form" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form action="{{ route('admin.segmen_kendaraan.insert') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myLargeModalLabel">Tambah Segmen Kendaraan</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row mb-1">
                                            <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Nama Segmen Kendaraan <span class="text-danger"><small>*</small></span> </label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" name="nama_segmen_ken" id="nama_segmen_ken" value="" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                    ...
                    <div class="card-body">
                        <table id="datatable" class="table table-bordered dt-responsive tabel-sm nowrap w-100 tabel-sm">
                            ...
                            <tbody>
                                ...
                                $no=1;
                                @endphp
                                @foreach ($dt_segmen_kendaraan as $item_segmen_kendaraan)
                                <tr>
                                    <td style="padding: 7px 5px;">{{ $no++ }}</td>
                                    <td style="padding: 7px 5px;" hidden>{{ $item_segmen_kendaraan->id }}</td>
                                    <td style="padding: 7px 5px;">{{ $item_segmen_kendaraan->nama_segmen_kendaraan }}</td>
                                    <td style="padding: 7px 5px;">{{ $item_segmen_kendaraan->keterangan }}</td>
                                    <td style="padding: 7px 5px;">
                                        <a href="#" class="btn btn-success btn-sm waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".modal-form{{ $item_segmen_kendaraan->id }}" style="padding: 1px 10px 1px 10px;">edit</a>
                                        <a href="#" id="delitems" class="btn btn-danger btn-sm waves-effect waves-light" style="padding: 1px 10px 1px 10px;">delete</a>
                                    </td>
                                </tr>
                                <!--  Large modal example -->
                                <div class="modal fade modal-form{{ $item_segmen_kendaraan->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row mb-1">
                                                        ...
                                                        <div class="col-sm-9">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" name="nama_segmen_ken_update" id="nama_segmen_ken_update" value="" placeholder="" required>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-1">
