            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('admin.utilitas.create') }}" class="btn btn-primary btn-sm">Tambah Utilitas <i class="mdi mdi-arrow-right ms-1"></i></a>
                        @elseif (Auth::user()->roles == 'Admin')
                        <a href="{{ route('user.utilitas.create') }}" class="btn btn-primary btn-sm">Tambah Utilitas <i class="mdi mdi-arrow-right ms-1"></i></a>
                        @endif
