            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">INPUT BIAYA STNK</h4>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            @if (Auth::user()->roles == 'Superadmin')
                                <form action="{{ route('admin.stnk.insert') }}" method="post">
                                @elseif (Auth::user()->roles == 'Admin')
                                    <form action="{{ route('user.stnk.insert') }}" method="post">
                            @endif
                            {{ csrf_field() }}
                            <div class="row mb-1">
                            ...
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Jenis<span
                                        class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Tipe<span
                                        class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="tipe" id="tipe"
                                        value="" placeholder="" required readonly>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">No Rangka<span
                                        class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="no_rangka"
                                        id="no_rangka" value="" placeholder="" required readonly>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">No Mesin<span
                                        class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="no_mesin"
                                        id="no_mesin" value="" placeholder="" required readonly>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Bulan Exp
                                    STNK<span class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="bulan_exp_stnk"
                                        id="bulan_exp_stnk" value="" placeholder="" required readonly>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">STNK<span
                                        class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="stnk"
                                        id="stnk" value="" placeholder="" required readonly>
                                </div>
                            </div>
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">PLAT<span
                                        class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="plat"
                                        id="plat" value="" placeholder="" required readonly>
                                </div>
                            </div>
                            {{-- <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Bulan Exp Kir<span class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="bulan_exp_kir" id="bulan_exp_kir" value="" placeholder="" required readonly>
                                </div>
                            </div> --}}
                            {{-- <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Tgl Kir<span class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="tgl_kir" id="tgl_kir" value="" placeholder="" required readonly>
                                </div>
                            </div> --}}
                            <div class="row mb-1">
                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Biaya STNK<span
                                        class="text-danger"><small>*</small></span> </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="biaya_sntk"
                                        id="biaya_sntk" value="" placeholder="" required>
                                </div>
                            </div>
...
@push('script-custome')
    <script>
        $(document).on('click', '.pilih', function(e) {
            ...
            $("#no_rangka").val($(this).attr('data-rangka'))
            $("#no_mesin").val($(this).attr('data-mesin'))
            $("#bulan_exp_stnk").val($(this).attr('data-bulanexp'))
            $("#stnk").val($(this).attr('data-stnk'))
            $("#plat").val($(this).attr('data-plat'))
            // $("#bulan_exp_kir").val($(this).attr('data-vol_ideal'))
            // $("#tgl_kir").val($(this).attr('data-vol_ideal'))
